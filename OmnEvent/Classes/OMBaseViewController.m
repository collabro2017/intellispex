...
- (void)initializeNavigationBar
{
    ...
    NSString *titleString = @"INTELLISPEX";
    NSMutableAttributedString *titleAttributedString;
    if ([titleString isEqualToString:@"INTELLISPEX"]) {
...
{
    [TABController newPostAction:kTypeUploadEvent mediaKind:kTypeCaptureAll currentObject:nil postOrder:-1 thumbnailPostOrder:-1 sortFlag:false];
}
...
- (void)inviteViaEmail
{
    if ([MFMailComposeViewController canSendMail])
    {
        ...
        [mailView setSubject:@"Enjoy INTELLISPEX App!"];
        [mailView setMessageBody:@"Created by INTELLISPEX App!Please install it.\n http://apple.co/1ftcr3n" isHTML:YES];
...
- (void) inviteFriendsForApp
{
    ...
    NSString *textObject = @"Enjoy INTELLISPEX App!";
